        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
                <div class="card-body">
                    <table id="TB_Clientes" class="table table-bordered table-striped tableclientes" style="width:100%">
                      <thead>
                        <tr>
                          <th style="font-weight: bold; font-size:13px; font-family:Arial">Razon Social</th>
                          <th style="font-weight: bold; font-size:13px; font-family:Arial">RFC</th>
                          <th style="font-weight: bold; font-size:13px; font-family:Arial">Autorizacion Mercancia</th>
                          <th style="font-weight: bold; font-size:13px; font-family:Arial">Activo</th>
                          <th style="font-weight: bold; font-size:13px; font-family:Arial">Estatus Revision Ofac</th>
                          <th style="font-weight: bold; font-size:13px; font-family:Arial">Imagen Cosulta Ofac</th>
                          <th style="font-weight: bold; font-size:13px; font-family:Arial">Fecha Cosulta Ofac</th>
                          <th style="font-weight: bold; font-size:13px; font-family:Arial">Acciones</th>
                          <th style="font-weight: bold; font-size:13px; font-family:Arial">Asociado</th>
                        ...
                        <?php
                            ...
                            if($_SESSION["perfil"] == 1)
                            {
                              ...
                              $cliente = ControladorPersona::ctrMostrarAsociadoUsuario($item, $valor);
                            ...
                            echo ' <tr>
                                    ...
                                    <td style="font-size:11px; font-family:Arial">'.$value["MercanciaAutorizada"].'</td>';
                                ...
                                if ($_SESSION["perfil"] == 1){
                                  ...
                                  if($value["Activo"] != 0){
                                    ...
                                    echo '<td style=" font-size:11px; font-family:Arial">Activado</td>';
  
                                    }else{
  
                                        echo '<td style=" font-size:11px; font-family:Arial">Desactivado</td>';
                                ...
                                if ($_SESSION["perfil"] == 1){
                                  ...
                                  if($value["Estatus"] != "Pendiente"){
                                    ...
                                    echo '<td><button class="btn btn-success btn-xs btnActivarCliente" idCliente="'.$value["Id"].'" estadoCliente="Autorizado">Autorizado</button></td>';
  
                                    }else{
  
                                        echo '<td><button class="btn btn-danger btn-xs btnActivarCliente" idCliente="'.$value["Id"].'" estadoCliente="Pendiente">Pendiente</button></td>';
                          ...
                          echo '<td>
                                ...
                                ';
                            echo '<td style=" font-size:11px; font-family:Arial">'.$value["AsociadoDecripcion"].'</td>
                              ...
                              echo'<td style="font-size:11px; font-family:Arial">'.$value["Colonia"].'</td>
                        ...
                        <div class="form-row mt-4">
                          <div class="col-6 col-sm-3 mt-4 mt-sm-0">
                              <div class="input-group mb-3">
                                      ...
                                      name="nuevoCuota_Rot" id="nuevoCuota_Rot" placeholder="Cuota ROT y Robo" />
                      ...
                      <div class="row">
                        <div class="col-md-6">
                            <div class="file-drop-area">
                                ...
                                <input type="hidden" id="rutalactualofac" name="rutalactualofac">
