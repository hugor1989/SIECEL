    ...
    <div class="row justify-content-center mt-0">
        <div class="col-11 col-sm-9 col-md-7 col-lg-6 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                <h2><strong>Registrar cuenta de Usuario</strong></h2>
                <p>Rellene todos los campos del formulario para ir al siguiente paso</p>
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form role="form" method="post" enctype="multipart/form-data" id="msform" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
                            <!-- progressbar -->
                            <ul id="progressbar">
