...
//if(isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok"){
 ...
 echo '<div class="wrapper">';
  ...
  if(isset($_GET["ruta"])){
    ...
    if($_GET["ruta"] == "inicio" ||
       $_GET["ruta"] == "usuarios" || //carga archivo usuarios.js
       $_GET["ruta"] == "crear-usuario" || //carga archivo usuarios.js
       $_GET["ruta"] == "perfiles" || //no carga arcivo js
       $_GET["ruta"] == "clientes" ||  //carga archivo clientes.js
       $_GET["ruta"] == "crear-cliente" ||  //carga archivo clientes.js
       $_GET["ruta"] == "giro" || //carga archivo clientes.js
       $_GET["ruta"] == "mercancia" || //carga archivo clientes.js
       $_GET["ruta"] == "crear-mercancia" || //carga archivo clientes.js
       $_GET["ruta"] == "aseguradora" || //carga archivo clientes.js
       /* $_GET["ruta"] == "cuota" || //carga archivo clientes.js
       $_GET["ruta"] == "cuota-aseguradora" || //carga archivo clientes.js */
       //$_GET["ruta"] == "cotizacion_imp" || //carga archivo clientes.js
       //$_GET["ruta"] == "asociado" || //carga archivo clientes.js
       $_GET["ruta"] == "certificado" || //carga archivo clientes.js
       //$_GET["ruta"] == "cotizacion" || //carga archivo clientes.js
       $_GET["ruta"] == "protocolo" || //carga archivo clientes.js
      // $_GET["ruta"] == "producto" || //carga archivo clientes.js
      // $_GET["ruta"] == "recorrido" || //carga archivo clientes.js
      // $_GET["ruta"] == "medio-transporte" || //carga archivo clientes.js
      // $_GET["ruta"] == "linea-transporte" || //carga archivo clientes.js
       $_GET["ruta"] == "cerrarsesion" || //carga archivo clientes.js
       $_GET["ruta"] == "ReporteAsociado" || //carga archivo clientes.js
       $_GET["ruta"] == "ReporteApar" || //carga archivo clientes.js
       $_GET["ruta"] == "ReporteAseguradora" || //carga archivo clientes.js
       $_GET["ruta"] == "autorizar-cotizacion" || //carga archivo clientes.js
       $_GET["ruta"] == "lista-certificados" || //carga archivo clientes.js
       $_GET["ruta"] == "paises" || //carga archivo clientes.js
       $_GET["ruta"] == "salir"){
