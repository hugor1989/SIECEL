	...
	$.ajax({
		...
		success: function(respuesta){
            ...
            for(var i=0; i<len; i++){
				...
				/* if(respuesta[i].IdEmpresaAsociada > 0){

					document.getElementById("Editar_Ch_EmpresaAsociada").checked = true;
					$("#Editar_SL_EmpresaAsociada> [value=" + respuesta[i].IdEmpresaAsociada + "]").attr("selected", "true");
					$('#Editar_Ch_EmpresaAsociada').trigger('change');
				}
 */
				if(respuesta[i].Foto != ""){
...
var form_count = 1, previous_form, next_form, total_forms;
	...
	$("#Editar_Ch_EmpresaAsociada").change(function () {
        if (this.checked) {
			var dv_paqueteria = document.getElementById("FM_Paqueteria");
            if (dv_paqueteria.style.display === "none") {
                dv_paqueteria.style.display = "flex";
			...
			document.getElementById("editarRFC").disabled = true;
			document.getElementById("editarCalle").disabled = true;
			document.getElementById("editarNumeroInterior").disabled = true;
			document.getElementById("editarNumeroExterior").disabled = true;
			document.getElementById("editarColonia").disabled = true;
			document.getElementById("editarMunicipio").disabled = true;
			document.getElementById("editarCP").disabled = true;
			document.getElementById("editarEstado").disabled = true;
			document.getElementById("editarPais").disabled = true;
			document.getElementById("editarGiro").disabled = true;
			document.getElementById("editarEmailAdicional").disabled = true;
			document.getElementById("editarTelefono").disabled = true;
			document.getElementById("editarCelular").disabled = true;
			document.getElementById("editarContacto").disabled = true;
			document.getElementById("editarCuentaBancaria").disabled = true;
			document.getElementById("editarCuentaBancariaAdicional").disabled = true;
			...
			document.getElementById("editarEmpresa").disabled = false;
			document.getElementById("editarRFC").disabled = false;
			document.getElementById("editarCalle").disabled = false;
			document.getElementById("editarNumeroInterior").disabled = false;
			document.getElementById("editarNumeroExterior").disabled = false;
			document.getElementById("editarColonia").disabled = false;
			document.getElementById("editarMunicipio").disabled = false;
			document.getElementById("editarCP").disabled = false;
			document.getElementById("editarEstado").disabled = false;
			document.getElementById("editarPais").disabled = false;
			document.getElementById("editarGiro").disabled = false;
			document.getElementById("editarEmailAdicional").disabled = false;
			document.getElementById("editarTelefono").disabled = false;
			document.getElementById("editarCelular").disabled = false;
			document.getElementById("editarContacto").disabled = false;
			document.getElementById("editarCuentaBancaria").disabled = false;
			document.getElementById("editarCuentaBancariaAdicional").disabled = false;
