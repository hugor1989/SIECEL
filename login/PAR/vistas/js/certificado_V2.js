  ...
  function ObtenerPrefijoAsociado(idasociado){
	...
	$.ajax({
		...
		success: function(respuesta){
			...
			$("#TB_Folio").val(respuesta["Abreviatura"]);
...
// 	if($(this).val() == "ROT Y ROBO" && $("#EMAYOR").val() == "NO"){
...
var form_count = 1, previous_form, next_form, total_forms;
	...
	$('#datos_certificado').submit(function(e){
		...
		Swal.fire({
				title: "Esta Seguro de Generar la Cotizacion",
				type: 'info',
				width: 600,
				padding: '3em',
				background: '#fff',
...
// 		if ($("#TB_NLITPTA").val().length == 0){

// 			Swal.fire({
// 				title:'Favor de Ingresar Nombre de Linea Transportista',
// 				width: 600,
// 				padding: '3em',
// 				background: '#fff',
// 				backdrop: `
...
// 			return false;
// 		}else if ($("#nuevoNbLNTRP").val() == ""){

// 			Swal.fire({
// 				title:'Favor de Seleccionar Tipo de Linea Transportista',
// 				width: 600,
// 				padding: '3em',
// 				background: '#fff',
// 				backdrop: `
...
// 			return false;
// 		}else if ($("#TB_NombreChofer").val().length == 0){

// 			Swal.fire({
// 				title:'Favor de Ingregsar el Nombre del Chofer',
// 				width: 600,
// 				padding: '3em',
// 				background: '#fff',
// 				backdrop: `
...
// 			return false;
// 		}else if ($("#nuevoTipoVehiculo").val() == ""){

// 			Swal.fire({
// 				title:'Favor de Seleccionar Tipo de Vehiculo',
// 				width: 600,
// 				padding: '3em',
// 				background: '#fff',
// 				backdrop: `
...
// 			return false;
// 		}else if ($("#TB_Marca").val().length == 0){

// 			Swal.fire({
// 				title:'Favor de Ingresar la Marca',
// 				width: 600,
// 				padding: '3em',
// 				background: '#fff',
// 				backdrop: `
...
// 			return false;
// 		}else if ($("#TB_Modelo").val().length == 0){

// 			Swal.fire({
// 				title:'Favor de Ingresar el Modelo',
// 				width: 600,
// 				padding: '3em',
// 				background: '#fff',
// 				backdrop: `
...
// 			return false;
// 		}else if ($("#TB_Placas").val().length == 0){

// 			Swal.fire({
// 				title:'Favor de Ingresar las Placas',
// 				width: 600,
// 				padding: '3em',
// 				background: '#fff',
// 				backdrop: `
...
// 			return false;
// 		}else if ($("#TB_Color").val().length == 0){

// 			Swal.fire({
// 				title:'Favor de Ingresar el Color',
// 				width: 600,
// 				padding: '3em',
// 				background: '#fff',
// 				backdrop: `
...
// 			return false;
// 		}else if ($("#TB_Motor").val().length == 0){

// 			Swal.fire({
// 				title:'Favor de Ingresar el N° de Motor',
// 				width: 600,
// 				padding: '3em',
// 				background: '#fff',
// 				backdrop: `
...
// 			return false;
// 		}else if ($("#TB_Serie").val().length == 0){

// 			Swal.fire({
// 				title:'Favor de Ingresar el N° de Serie',
// 				width: 600,
// 				padding: '3em',
// 				background: '#fff',
// 				backdrop: `
...
// 	else{
// 		Swal.fire({
// 				title: "Estar Seguro de Generar Certificado",
// 				type: 'info',
// 				showCancelButton: true,
// 				confirmButtonClass: "btn-primary",
// 				confirmButtonText: "Guardar",
...
// 			}).then((result) =>{
// 				if(result.value){
// 					//var asosiado = $("#nuevoAsociado").val(); //$( "#nuevoAsociado option:selected" ).text();
// 					var _cliente = $("#nuevoCliente").val();//$( "#nuevoCliente option:selected" ).text();
// 					var _Folio = $("#TB_Folio").val();
// 					var _Fecha = $("#DT_Actual").val();
...
// 					var _Valor_Embarque = $("#TB_ValorEmbarque").val();
// 					var _Moneda = "Pesos Mexicanos";
// 					//var _Medida_seguridad  = $("#nuevoSisSatelital").val();
// 					var _Descripcion_seguridad = $("#TB_DescripcionGPS").val();
// 					var _Doble_remolque = $("#nuevoRemolque").val();
// 					var _Ampara_contenedor = $("#nuevoContenedor").val();
// 					var _Tipocontenedorprimero = $("#nuevoTipoContenedor1").val();
...
// 						Moneda : _Moneda,
// 						Numero_remolque : _Numero_remolque,
// 						//Medida_seguridad : _Medida_seguridad,
// 						Descripcion_seguridad : _Descripcion_seguridad,
// 						Doble_remolque: _Doble_remolque,
// 						Ampara_contenedor : _Ampara_contenedor,
// 						Tipocontenedorprimero: _Tipocontenedorprimero, 
...
// 									Swal.fire({
// 												type:'success',
// 												title:'Certificado Registrado Exitosamente!' ,
// 												confirmButtonColor:'#3085d6',
// 												confirmButtonText:'Aceptar'
// 											}).then((result) => {
// 												if(result.value){
// 												impresionCertificadoPDF(folio,id);
