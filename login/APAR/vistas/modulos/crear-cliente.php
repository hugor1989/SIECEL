              ...
              <!--   <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group floating" style='padding:10px'>
                          ...
                          onkeyup="mayus(this);" oninput="validarInput(this.value)"  name="nuevoRFC" id="nuevoRFC" required>
                          <label for="usr">RFC</label>
                        </div>
                        <div class="form-group floating" style='padding:10px'>
                            <input type="text" class="form-control floating" 
                            onkeyup="mayus(this);" id="nuevoNombre" name="nuevoNombre" required>
                            <label for="usr">Razon Social</label>
                        </div>
                        <div class="form-group floating" style='padding:10px'>
                            <input type="text" class="form-control floating" 
                            name="nuevoEmail" id="nuevoEmail" oninput="ValidateEmail(this.value)" disabled required>
